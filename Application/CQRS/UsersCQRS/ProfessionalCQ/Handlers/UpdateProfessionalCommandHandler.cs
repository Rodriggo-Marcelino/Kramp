...
public class
    UpdateProfessionalCommandHandler : IRequestHandler<UpdateProfessionalCommand,
    ResponseBase<ProfessionalInfoViewModel>>
{
    ...
    public async Task<ResponseBase<ProfessionalInfoViewModel>> Handle(UpdateProfessionalCommand request,
