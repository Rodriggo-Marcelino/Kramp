...
{
    public class CreateManagerCommandValidator : CreateUserCommandValidator<Manager, CreateEntityCommandBase<Manager, CreateUserDTO, UserViewModel>, CreateUserDTO, UserViewModel>
    {
